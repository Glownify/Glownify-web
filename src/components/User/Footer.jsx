...
const Footer = () => {
  return (
    <footer className="mt-6 p-6 bg-linear-to-r from-[#FFF7F1] to-[#FFEDE2] text-black">
      <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-15">
        {/* Branding Section */}
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="mt-auto p-3 border border-black/10 rounded-lg bg-white/30 text-xs">
            <p className="font-medium">Facing issues? Reach out to us at:</p>
            <Link
              to="/contact-us"
