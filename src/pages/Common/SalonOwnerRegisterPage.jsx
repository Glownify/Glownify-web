...
import BasicInfoRegistrationForm from "../../components/SalonRegistrationForms/BasicInfoRegistrationForm";
import {
  fetchAllStates,
...
import bgImage from "../../assets/Salone Registation UI page.png";
import SalonAddressRegistrationForm from "../../components/SalonRegistrationForms/SalonAddressRegistrationForm";
import SalonDocumentUploadForm from "../../components/SalonRegistrationForms/SalonDocumentUploadForm";
...
const SalonOwnerRegisterPage = () => {
  ...
  return (
    ...
    // </div>
    <>
      {/* <div className="min-h-screen bg-[#fde9ef] relative overflow-hidden"> */}
      {/* 🔹 BACKGROUND IMAGE */}
<div style={{backgroundImage:{bgImage}}} className=" min-h-screen w-full bg-cover inset-0 pointer-events-none overflow-hidden">
 
  <div>
    Step {tab} / {total}
  </div>
  <div className="z-10 h-200">
    {tab===1&&(<BasicInfoRegistrationForm
    onNext={()=>setTab(2)}
    />)}
     {tab===2&&(<SalonAddressRegistrationForm
    onNext={()=>setTab(3)}
      onBack={()=>setTab(1)}
    
    />)}
     {tab===3&&(<SalonDocumentUploadForm
      onBack={()=>setTab(2)}
    />)}
  </div>
</div>
